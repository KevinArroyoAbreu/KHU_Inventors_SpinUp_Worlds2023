...
void init(int hue, int default_auton, const char **autons){
	...
	lv_obj_t *rollerTab = lv_tabview_add_tab(tabview, "Roller");
	lv_obj_t *nonrollerTab = lv_tabview_add_tab(tabview, "Non Roller");
	lv_obj_t *fullwpTab = lv_tabview_add_tab(tabview, "Skills (roller)");
	...
	// button matrix
	redBtnm = lv_btnm_create(rollerTab, NULL);
	...
	// blue tab
	blueBtnm = lv_btnm_create(nonrollerTab, NULL);
	...
	// skills tab
	lv_obj_t *skillsBtn = lv_btn_create(fullwpTab, NULL);
	lv_obj_t *label = lv_label_create(skillsBtn, NULL);
	lv_label_set_text(label, "Skills Prog.");
